...
public class HospitalParser implements Parser<Hospital>{
    ...
    public Hospital parse(String str) {
        ...
        hospital.setLicenseDate(this.makeLicenseDate(row[5]));
    ...
    private LocalDateTime makeLicenseDate(String str) {
        return LocalDateTime.of(
                Integer.parseInt(str.substring(0, 4)),  // year
                Integer.parseInt(str.substring(4, 6)),  // month
                Integer.parseInt(str.substring(6, 8)),  // date
                0, 0, 0);
    }
}
